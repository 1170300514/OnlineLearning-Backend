...
import top.xyzhang.educenter.utils.ConstantWxUtils;
import top.xyzhang.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String getWxCode() {
        ...
        try {
            ...
            throw new MyTestException(20001, "生成微信二维码时url组装失败");
        }
    ...
    public String callback(String code, String state) {
        ...
        try {
            ...
            if(member == null) {//member是空，表没有相同微信数据，进行添加
                ...
                member = memberService.saveWxLogin(openid, nickname, headimgurl);
            }
